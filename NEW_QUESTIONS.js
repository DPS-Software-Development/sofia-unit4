...
// 60 domande di ripasso (Quiz 20 + Fill 18 + TF 15 + Seq 7)
// Topic: Shops / Containers / Money
// Sorgente: UNIT4_INVENTORY.md (pp. 74-95)
...
const SEQUENCE = [
  ...
  },
  {
    prompt: "Metti in ordine il mini-dialogo p.78:",
    items: [
      "What can I buy at the chemist's?",
  ...
  },
  {
    ...
    items: [
      "Can I have a kilo of potatoes, please?",
      "I'm sorry, I haven't got potatoes today."
    ],
    tag: "Containers"
  },
  ...
  // ===== MONEY (3) =====
  {
    ...
    items: [
      "Excuse me, how much is a packet of pasta?",
      "It's £2.",
  ...
  },
  {
    ...
    items: [
      ...
      "Can I have a jacket potato, please?",
      "It's £2.60. Anything else?",
      "Thank you!"
    ],
    tag: "Money"
  },
  {
    ...
    items: [
      "Excuse me, how much is the mug?",
      "It's £4.95.",
      "And how much is a magnet?",
